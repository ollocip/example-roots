            ...
            <li id="accordion-section-{{ data.id }}"
                ...
                <h3 class="accordion-section-title">
                    ...
                    <# if ( data.pro_text && data.pro_url ) { #>
                        ...
                        <# } #>
                            <br>
                            <span class="customize-action">{{ data.description }}... <a class="customize-action" target="_blank" href="<?php echo esc_url('https://demo.snapthemes.io/unisco-pro/?utm_source=unisco_lite_info_page'); ?>"><?php esc_html_e('demo','unisco'); ?></a></span>
                </h3>
            </li>
		<?php }
	}
	    ...
	    $wp_customize->add_section(
		    new Unisco_Customize_Section_Pro(
			    ...
			    array(
				    ...
				    'pro_url'     => esc_url('https://snapthemes.io/products/unisco-education-wordpress-theme/?utm_source=unisco_lite_customizer'),
