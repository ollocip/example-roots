...
$wp_customize->add_setting('unisco_slides', array(
	'default'           => json_encode( array(
		array(
			'content' => '',
			'title' => __('Creative Thinking & Innovation', 'unisco'),
			'description' => __('Proactively utilize open-source users for process-centric total linkage.<br> Energistically reinvent web-enabled initiatives with premium <br>processes. Proactively drive.', 'unisco'),
			'background_image' => get_template_directory_uri() . '/images/slider.jpg',
			'button_1_text' => __('See programs', 'unisco'),
			'button_1_url' => '#',
			'button_2_text' => __('Learn More', 'unisco'),
			'button_2_url' => '#',
		),
		array(
			'content' => '',
			'title' => __('We foster wisdom', 'unisco'),
			'description' => __('Proactively utilize open-source users for process-centric total linkage.<br> Energistically reinvent web-enabled initiatives with premium <br>processes. Proactively drive.', 'unisco'),
		...
		array(
			'content' => '',
			'title' => __('Campus life @ Unisco', 'unisco'),
			'description' => __('Proactively utilize open-source users for process-centric total linkage.<br> Energistically reinvent web-enabled initiatives with premium <br>processes. Proactively drive.', 'unisco'),
			'background_image' => get_template_directory_uri() . '/images/slider-3.jpg',
			'button_1_text' => __('Campus life', 'unisco'),
			'button_1_url' => '#',
			'button_2_text' => '',
			'button_2_url' => '',
		),
